            ...
            <div className="flex-1 pb-8">
              <Card className="bg-black/[0.01] dark:bg-white/[0.02] border-black/[0.05] dark:border-white/[0.08] hover:border-indigo-400/30 transition-all duration-500 ease-in-out overflow-hidden group relative hover:shadow-lg hover:-translate-y-1">
                <div className="p-4 md:p-5">
                  ...
                  {/* Duration */}
                  <p className="text-black/50 dark:text-white/50 text-xs mb-2 transition-all duration-300 ease-in-out group-hover:text-black/60 dark:group-hover:text-white/60">August 2025 - Present</p>
                  ...
                  <ul className="list-disc pl-5 text-black/70 dark:text-white/70 text-sm leading-relaxed mb-4 transition-all duration-300 ease-in-out group-hover:text-black/80 dark:group-hover:text-white/80 space-y-1">
                    <li className="hover:scale-[1.01] hover:shadow-sm transition-all duration-300 ease-in-out">Developing and deploying <span className="font-bold">LangGraph agents</span> for dynamic workflow automation.</li>
                    <li className="hover:scale-[1.01] hover:shadow-sm transition-all duration-300 ease-in-out">Integrating <span className="font-bold">Meta WhatsApp APIs</span> to enable AI-driven customer interactions.</li>
                    <li className="hover:scale-[1.01] hover:shadow-sm transition-all duration-300 ease-in-out">Building a <span className="font-bold">voice agent</span> using LiveKit and open-source tech stacks for real-time communication.</li>
                  </ul>
